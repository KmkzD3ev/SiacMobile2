...
public class VendasPedidosComProdutosDomain {
    ...
    // Construtor
    public VendasPedidosComProdutosDomain(String codigo_venda, String codigo_cliente, String unidade_venda, String produto_venda,
                                          String data_movimento, String quantidade_venda, String preco_unitario, String valor_total,
                                          String vendedor_venda, String status_autorizacao_venda, String entrega_futura_venda,
                                          String entrega_futura_realizada, String usuario_atual, String data_cadastro,
                                          String codigo_venda_app, String chave_importacao, String formas_pagamento) {
        ...
        this.listaProdutos = new ArrayList<>(); // Inicializa como uma lista vazia
    }
    ...
    // Getter e Setter para a lista de produtos
    public ArrayList<ProdutoEmissor> getListaProdutos() {
        return listaProdutos;
    }

    public void setListaProdutos(ArrayList<ProdutoEmissor> listaProdutos) {
